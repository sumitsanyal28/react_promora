		...
		<div class="container">
			<div class="ContactInfo">
				<div>
					...
					<ul class="info">
						<li>
							<span><img src="../images/location.png" alt="lication"></img></span>
							<span>Admin Update</span>
						</li>
						<li>
							<span><img src="../images/mail.png" alt="mail Id"></img></span>
							<span><a href="mailto:promora07@gmail.com">promora07@gmail.com</a></span>
						</li>
						<li>
							<span><img src="../images/call.png" alt="call"></img></span>
							<span><a href="tel:+9179800 72892">(91) 7980072892</a></span>
						</li>
						<li>
							<span><img src="../images/whatsapp.png" alt="whats app"></img></span>
							<span><a href="tel:+917980072892">(91) 7980072892</a>
								 <a href="tel:+918240346055">(91) 8240346055</a>
							</span>
						</li>
						<li>
							<span><img src="../images/work24.png" alt="Working Hours"></img></span>
				...
				<div class="FollowUs">
					<h3>Follow Us On :</h3>
					<ul class="sci">
						<li><a href="https://www.facebook.com/promora07/" target="_blank"><img src="../images/1.png"
									alt="Facebook"></img></a></li>
						<li><a href="https://twitter.com/promora07/likes?s=09" target="_blank"><img src="../images/2.png"
									alt="Twitter"></img></a></li>
						<li><a href="https://www.instagram.com/promora07/" target="_blank"><img src="../images/3.png"
									alt="Instragram"></img></a></li>
						<li><a href="https://www.linkedin.com/company/promora07/" target="_blank"><img
									src="../images/5.png" alt="LinkedIn"></img></a></li>
						<li><a href="https://www.youtube.com/channel/UCElhxb5vK2ZCLd47acg2Owg/featured"
								target="_blank"><img src="../images/youtube_icon_24.png" alt="YouTube"></img></a></li>
					</ul>
				</div>
			</div>
